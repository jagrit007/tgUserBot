...
async def chuanimation(e):
    ...
    for i in range(0, 30):
            ...
            await e.edit(animation_chars[i % 30])
...
async def _(e):
    ...
    for i in range(0, 27):
        ...
        await e.edit(animation_chars[i % 27])


@register(outgoing=True, pattern="^.ravana$")
async def _(e):
    if e.fwd_from:
        return
    animation_chars = [
...
@register(outgoing=True, pattern="^.repe$")
async def _(e):
    if e.fwd_from:
        return
    animation_chars = [
...
async def _(e):
    ...
    for i in range(0, 28):
        ...
        await e.edit(animation_chars[i % 28])


@register(outgoing=True, pattern="^.solar$")
async def _(e):
    if e.fwd_from:
        return
...
"`◼️◼️◼️◼️◼️\n◼️◼️◼️◼️☀\n◼️◼️🌎◼️◼️\n🌕◼️◼️◼️◼️\n◼️◼️◼️◼️◼️`",
    ...
    for i in range(0, 549755813888):
        await asyncio.sleep(0.1)
        await e.edit(animation_chars[i % 549755813888])
...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("https://github.com/jagrit007/tgUserBot/")

@register(outgoing=True, pattern="^.readme$")
async def reedme(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("https://github.com/jagrit007/tgUserBot/blob/master/README.md")
